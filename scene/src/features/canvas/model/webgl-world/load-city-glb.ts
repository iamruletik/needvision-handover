...
export const CITY_GLB_URL = staticUrl('/static/gltf/city5.3_opt.glb');

// Google-hosted draco decoders — no cross-origin worker fetch problems, always cached
export const CITY_DRACO_DECODER_PATH = 'https://www.gstatic.com/draco/versioned/decoders/1.5.7/';
