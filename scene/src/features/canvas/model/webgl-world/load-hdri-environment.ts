...
export const HDRI_URL = staticUrl('/static/textures/hdri/sunset_in_the_chalk_quarry_1k.hdr');

export const WATER_HDRI_URL = staticUrl('/static/textures/hdri/ferndale_studio_08_1k.hdr');
